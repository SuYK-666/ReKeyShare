...
public final class ThresholdReEncryptionService {
	public record SignedShare(String proxyId, ThresholdReKeyShare share, String shareDigest, String signatureAlgorithm,
	...
	private static String shareDigest(String proxyId, ThresholdReKeyShare share) {
		return Hash.sha256Hex(Bytes.concat(Bytes.utf8("threshold-share-v1|" + proxyId + "|" + share.threshold() + "|"
				+ share.totalShares() + "|" + share.index() + "|"), share.value()));
	}
