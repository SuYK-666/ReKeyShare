...
public final class KeyLifecycleService {
	public enum RevocationMode {
		SOFT_REVOKE, HARD_REVOKE, EMERGENCY_REVOKE
	}
	...
	public ShareGrant softRevoke(String ownerId, String grantId, String reason) {
		...
		audit.record(new com.example.pre.model.AuditEvent(Instant.now(), ownerId, "SOFT_REVOKE_EFFECTIVE", grantId,
				true, "new transformations and package downloads blocked"));
		return revoked;
	}

	public RotationResult hardRevoke(User owner, String grantId, String reason,
