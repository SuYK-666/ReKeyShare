...
public final class DemoTokenService {
	...
	public record AuthenticatedActor(String userId, UserRole role, String tenantId, String tokenId, long issuedAt,
			long expiresAt) {
	...
	public String issue(User user) {
		...
		String payload = user.userId() + "|" + user.role().name() + "|" + issuedAt + "|" + expiresAt + "|" + tokenId
				+ "|default|" + issuer + "|" + audience + "|" + activeKeyId;
