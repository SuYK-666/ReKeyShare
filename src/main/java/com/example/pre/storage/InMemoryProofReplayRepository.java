...
public final class InMemoryProofReplayRepository implements ProofReplayRepository {
    ...
    @Override
    public synchronized boolean consume(String tenantId, String proxyId, String keyId, long keyEpoch,
    ...
    private static String key(String tenantId, String proxyId, String keyId, long keyEpoch,
                              String proofNonce, String canonicalPayloadHash) {
        return String.join("|", tenantId, proxyId, keyId, Long.toString(keyEpoch), proofNonce,
