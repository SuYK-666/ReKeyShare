...
public final class AuditTamperApplication {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("  \"audit-field-tamper\":\"" + pass(!AuditService.verifyChain(fieldTamper).valid()) + "\",");
		System.out
				.println("  \"audit-delete-event\":\"" + pass(!AuditService.verifyChain(deleteTamper).valid()) + "\",");
		System.out.println(
				"  \"audit-reorder-event\":\"" + pass(!AuditService.verifyChain(reorderTamper).valid()) + "\",");
