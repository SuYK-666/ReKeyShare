...
public record KeyVersion(String keyId, String userId, AlgorithmType algorithm, int version, KeyPurpose keyPurpose,
		PublicKeyMaterial publicKey, String fingerprint, KeyStatus status, Instant createdAt, Instant activatedAt,
		Instant expiresAt, Instant rotatedAt, Instant revokedAt, String revokeReason) {
