...
public interface PreScheme {
	...
	default ReEncryptionKey generateReKey(ReKeyGenerationRequest request) {
		throw new UnsupportedOperationException(
				"scheme-specific re-key generation is handled by authorization services");
	}

	default EncryptedKeyCapsule reEncrypt(EncryptedKeyCapsule originalCapsule, ReEncryptionKey reKey,
