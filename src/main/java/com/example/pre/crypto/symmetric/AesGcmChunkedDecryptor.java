...
public final class AesGcmChunkedDecryptor {
	...
	public static void decryptAndVerify(InputStream input, OutputStream output, byte[] key, byte[] baseAad,
			AesGcmChunkedEncryptor.Manifest manifest, String expectedMerkleRoot) throws IOException {
