...
public final class AesGcmNonceManager {
	...
	private static final Path REGISTRY = Path
			.of(System.getProperty("rekeyshare.nonce.registry", "storage/security/aes-gcm-nonces.txt"));
	...
	private static void persist(String entry) {
		try {
			...
			Files.writeString(REGISTRY, entry + System.lineSeparator(), StandardOpenOption.CREATE,
