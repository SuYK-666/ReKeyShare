...
public final class AadBuilder {
	...
	public static String buildString(CapsuleContext context) {
		return lengthPrefix("tenantId", context.tenantId()) + lengthPrefix("dataId", context.dataId())
				+ lengthPrefix("ownerId", context.ownerId()) + lengthPrefix("recipientId", context.recipientId())
				...
				+ lengthPrefix("policyHash", context.policyHash()) + lengthPrefix("grantId", context.grantId())
