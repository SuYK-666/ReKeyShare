...
class EccCollusionBoundaryTest {
	...
	void proxyRekeyAndRecipientPrivateKeyRevealOwnerScalarInBaseline() {
		...
		EccReEncryptionKey proxyRekey = (EccReEncryptionKey) generator.generateReEncryptionKey(ownerPrivate,
				(com.example.pre.crypto.ecc.EccPublicKeyMaterial) recipient.publicKey(), share, context);
