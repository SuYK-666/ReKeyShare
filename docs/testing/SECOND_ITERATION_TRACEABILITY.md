...
| P0-03 secure-local security state | partial: audit/replay/idempotency/object/key wired; live domain stores pending | `RuntimeProfile`, `ReKeyShareApplication`, JDBC/file adapters | `ApiIntegrationTest`, JDBC tests, `ObjectStoreTest` | `deployment.md`, `storage/repository-design.md` |
